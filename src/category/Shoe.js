...
//       const cat = products.map((i) => i.gender==="shoe"  )
//   console.log(cat);
  ...
  const finalfiltering=()=>{
    let transformedproduct=shoecategoryfilter;
    ...
    if(sort==''||undefined) {
      transformedproduct=shoecategoryfilter;
...
return transformedproduct;
  ...
  return (
    ...
    <Announceoffer/>
     <Header />
      <div className="mainshoe">
        <div className="leftshoe">
          <div className="heading">Filter Products</div>
          <div className="formshoe">
            <Form>
              <div className="mb-3">
                <Form.Check
                  className="pb-3"
