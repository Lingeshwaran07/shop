...
//       const cat = products.map((i) => i.category  )
//   console.log(cat);
  ...
  const finalfiltering=()=>{
    let transformedproduct=womencategoryfilter;
    ...
    if(sort==''||undefined) {
      transformedproduct=womencategoryfilter;
    ...
    <Announceoffer/>
     <Header />
      <div className="mainwomen">
        <div className="leftwomen">
          <div className="heading">Filter Products</div>
          <div className="formwomen">
            <Form>
              <div className="mb-3">
                <Form.Check
                  className="pb-3"
